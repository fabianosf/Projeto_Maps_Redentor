...
"""Mock local de funcionários ERP — usado com REDMAPA_ERP_ENABLED=0."""
...
# Matrícula (string normalizada) → nome. Sem foto no mock.
...
def consultar_funcionario_mock(matricula: str) -> dict[str, Any] | ErpError:
    """
    Mesmo formato de consultar_funcionario_erp:
    ...
    # Aceita "59800" e variantes com zeros à esquerda equivalentes numericamente.
