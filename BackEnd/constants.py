...
# Admin, Despachante e Inspetor (P1 — Inspetor com escopo local/empresa/turno)
PERFIS_MAPA = {PERFIL_ADMIN, PERFIL_DESPACHANTE, PERFIL_INSPETOR}
# Banco de horas operacional: Admin, Despachante e Inspetor
PERFIS_BANCO_HORAS = {PERFIL_ADMIN, PERFIL_DESPACHANTE, PERFIL_INSPETOR}
COD_MAP_MAX = 99999
