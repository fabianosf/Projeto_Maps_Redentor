...
export function BottomTabBar({ activeTab, onSelect }: Props) {
  return (
    <nav
      className="fixed bottom-0 left-1/2 z-40 flex w-full max-w-phone -translate-x-1/2 border-t border-slate-200/90 bg-white/95 px-0.5 pt-1 shadow-[0_-4px_16px_rgba(15,23,42,0.06)] backdrop-blur-md pb-[max(0.35rem,env(safe-area-inset-bottom))]"
