...
ARCH_ASCII_DIAGRAM = [
    ...
    "│  (browser)      │   cookie HttpOnly   │  Flask + DAL         │   MariaDB    │  banco map  │",
    "└─────────────────┘                     └──────────────────────┘              └─────────────┘",
    "                                                │",
    "                                                │ sessão em memória",
    "                                                ▼",
...
FOLDER_TREE = [
    ...
    "│   └── CONF.py      # Leitura de configs criptografadas",
        ...
        [
            ...
            build_3col_table(
                ...
                [
                    ...
                    ("DAL (MariaDB)", "≥ 1.1", "Camada de acesso ao banco"),
            ...
            build_3col_table(
                ...
                [
                    ...
                    ("Configuração", "Parâmetros criptografados de conexão", "BackEnd/CONF.py, DAL/arquivos_crip*.dat, DAL/arquivos_cripchave.key"),
        ...
        [
            ...
            build_3col_table(
                ...
                [
                    ...
                    ("API ↔ MariaDB", "TCP (porta 3306)", "SQL parametrizado via DAL"),
    ...
    nodes.extend(
        [
            ...
            build_3col_table(
                ...
                [
                    ("REDMAPA_CONFIG", "map.dat", "Arquivo de configuração em DAL/arquivos_crip"),
