...
CREATE TABLE IF NOT EXISTS tb_item_map (
    ...
    inicio_real    DATETIME DEFAULT NULL COMMENT 'Início real da escala',
    fim_real       DATETIME DEFAULT NULL COMMENT 'Fim real / data_hora_baixa',
    status_escala  VARCHAR(20) NOT NULL DEFAULT 'EM_ANDAMENTO'
        COMMENT 'EM_ANDAMENTO | ENCERRADA — ocupa veículo/motorista se EM_ANDAMENTO',
    baixa_em       DATETIME DEFAULT NULL COMMENT 'Data/hora da baixa operacional (compat)',
    data_baixa     DATE DEFAULT NULL COMMENT 'Data da baixa (derivada de fim_real/baixa_em)',
    hora_baixa     TIME DEFAULT NULL COMMENT 'Hora da baixa (derivada de fim_real/baixa_em)',
    motivo_baixa   VARCHAR(120) DEFAULT NULL,
    observacao_baixa VARCHAR(500) DEFAULT NULL,
    duracao_trabalhada_minutos INT DEFAULT NULL COMMENT 'Minutos efetivos fim_real - inicio_real',
    PRIMARY KEY (id_item),
    ...
    KEY idx_tb_item_map_status_escala (status_escala),
    KEY idx_tb_item_map_veiculo_status (id_veiculo, status_escala),
    KEY idx_tb_item_map_motorista_status (id_motorista, status_escala),
